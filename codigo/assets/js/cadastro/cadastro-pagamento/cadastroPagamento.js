document.addEventListener('DOMContentLoaded', () => {
    ...
    function saveToLocalStorage(data) {
      ...
      alert('Serviço pago com sucesso!');
    ...
    function createNewForm() {
      const originalForm = document.querySelector('.cadastro-servico-form');
    ...
    viewStoredDataButton.addEventListener('click', () => {
      window.location.href = '/codigo/pages/empregador/visualizar-pagamento.html';
    });
  
    // Adicionar eventos ao formulário inicial
    const initialForm = document.querySelector('.cadastro-servico-form');
    if (initialForm) {
